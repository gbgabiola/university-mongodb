...
1. `{ lastName: 1, firstName: 1, accountBalance: 1, city: 1 }`
2. `{ city: 1, lastName: 1, firstName: 1, accountBalance: 1 }`
3. `{ accountBalance: 1, city: 1, lastName: 1, firstName: 1 }`
4. `{ lastName: 1, firstName: 1, city: 1, accountBalance: 1 }`
